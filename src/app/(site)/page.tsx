...
export default async function HomePage() {
  ...
  return (
    <>
        ...
        >
            ...
            <span className="inline-flex items-center gap-2">
              <i
                className="
                  ...
                  rounded-full
                  bg-emerald-600
                  shadow-[0_0_0_4px_rgba(34,197,94,.12)]
                "
              />
          ...
          <div
            className="
              ...
              lg:grid-cols-[minmax(0,1.65fr)_minmax(280px,.55fr)]
              lg:gap-20
            "
          >
            <div>
              <p className={kicker}>
                {settings.fullName.toUpperCase()}
                {" / "}
                SOFTWARE ENGINEER
              </p>
      ...
      {/* ======================================================= */}
      {/* EDUCATION                                               */}
      {/* SAME PRIMARY SURFACE AS EXPERIENCE                      */}
      {/* ======================================================= */}
